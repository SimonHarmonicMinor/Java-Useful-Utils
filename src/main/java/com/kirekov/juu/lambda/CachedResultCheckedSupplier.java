...
/**
 * Implementation for {@linkplain CheckedSupplier} which calculates value only for the first time
 * and then returns cached result. This implementation is not thread-safe.
 *
