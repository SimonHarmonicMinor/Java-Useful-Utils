...
/**
 * Implementation for {@linkplain Supplier} which calculates value only once for the first time and
 * then returns cached result. This implementation is not thread safe.
 *
