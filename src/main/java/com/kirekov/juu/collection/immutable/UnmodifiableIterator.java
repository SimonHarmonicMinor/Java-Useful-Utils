...
/**
 * An implementation of {@link Iterator} that forbids removing elements. Behaves as a wrapper that
 * accepts actual iterator and allows to call concrete methods.
 *
...
public class UnmodifiableIterator<T> implements Iterator<T> {
  ...
  /**
   * Always throws {@link UnsupportedOperationException}. Declared as final in order not be
   * overridden.
   *
