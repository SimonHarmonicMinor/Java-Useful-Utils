...
public interface ImmutableMap<K, V> {
   ...
   *                          The first param is the key. The second param is the value from the
   *                          current map. The third param is the value from the given map. Function
   *                          returns the value that will be added to the final result.
   * @return new map with merged pairs
